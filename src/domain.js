...
function createSeedState(nowValue = new Date()) {
  ...
  const availabilitySlots = [
    ...
    { id: id(), userId: studentA.id, dayOfWeek: 4, startTime: "12:30", endTime: "14:00", busy: true },
    { id: id(), userId: studentA.id, dayOfWeek: 5, startTime: "11:00", endTime: "12:30", busy: true },
    { id: id(), userId: studentA.id, dayOfWeek: 5, startTime: "14:30", endTime: "16:00", busy: true },
    { id: id(), userId: studentA.id, dayOfWeek: 6, startTime: "10:00", endTime: "11:30", busy: true },
    ...
    { id: id(), userId: studentB.id, dayOfWeek: 5, startTime: "15:00", endTime: "16:30", busy: true },
    { id: id(), userId: studentB.id, dayOfWeek: 6, startTime: "11:00", endTime: "12:30", busy: true },
    ...
    { id: id(), userId: studentC.id, dayOfWeek: 5, startTime: "15:30", endTime: "17:00", busy: true },
    { id: id(), userId: studentC.id, dayOfWeek: 6, startTime: "09:30", endTime: "11:00", busy: true },
  ];
  ...
  const dmManagerMayaThread = normalizeDmThreadId(manager.id, studentA.id);
  const dmMayaJordanThread = normalizeDmThreadId(studentA.id, studentB.id);
    ...
    messages: [
      {
        ...
        senderId: manager.id,
        recipientId: null,
        body: "Welcome team. Please confirm your assigned shifts at least 2 hours early.",
        sentAt: minusHours(7),
      },
      {
        id: id(),
        ...
        recipientId: null,
        body: "I can help with extra library shifts this week if needed.",
        sentAt: minusHours(6.5),
      },
      {
        id: id(),
        channelType: CHANNEL.GROUP,
        ...
        senderId: manager.id,
        recipientId: null,
        body: "Thanks Jordan. Please also keep your class availability updated before claiming.",
        sentAt: minusHours(6.2),
      },
      {
        id: id(),
        channelType: CHANNEL.DM,
        threadId: dmManagerMayaThread,
        senderId: manager.id,
        recipientId: studentA.id,
        body: "Hi Maya, can you confirm tonight's library assignment?",
        sentAt: minusHours(5.5),
      },
      {
        id: id(),
        channelType: CHANNEL.DM,
        ...
        body: "Yes, confirming in the app now.",
        sentAt: minusHours(5.3),
      },
      {
        id: id(),
        channelType: CHANNEL.DM,
        threadId: dmMayaJordanThread,
        senderId: studentA.id,
        recipientId: studentB.id,
        body: "Are you free to cover one shift later this week if needed?",
        sentAt: minusHours(4.6),
      },
      {
        id: id(),
        channelType: CHANNEL.DM,
        ...
        senderId: studentB.id,
        recipientId: studentA.id,
        body: "Possibly, send me the slot and I can check.",
        sentAt: minusHours(4.4),
      },
      {
        id: id(),
        channelType: CHANNEL.SHIFT_THREAD,
        threadId: "shift_assigned_pending_3",
        senderId: studentC.id,
        recipientId: null,
        body: "I requested a swap for this front desk shift due to lab overlap.",
        sentAt: minusHours(2.2),
      },
      {
        id: id(),
        channelType: CHANNEL.SHIFT_THREAD,
        ...
        senderId: studentA.id,
        recipientId: null,
        body: "I can take it if approved.",
        sentAt: minusHours(2.0),
      },
      {
        id: id(),
        channelType: CHANNEL.SHIFT_THREAD,
        ...
        senderId: manager.id,
        recipientId: null,
        body: "Reviewing this request now. Thanks both.",
        sentAt: minusHours(1.8),
      },
      {
        id: id(),
        channelType: CHANNEL.SHIFT_THREAD,
        threadId: "shift_assigned_pending_2",
        senderId: studentB.id,
        recipientId: null,
        body: "Submitted a drop request for this shift due to an exam conflict.",
        sentAt: minusHours(1.4),
      },
      {
        id: id(),
        channelType: CHANNEL.SHIFT_THREAD,
        ...
        senderId: manager.id,
        recipientId: null,
        body: "Received. I will re-release coverage if approved.",
        sentAt: minusHours(1.2),
      },
    ],
    notifications: [],
    emailLog: [],
